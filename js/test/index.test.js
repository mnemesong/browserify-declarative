...
(0, mocha_1.it)("test browserifyDeclarative", function () { return __awaiter(void 0, void 0, void 0, function () {
    var targetFilePath;
    return __generator(this, function (_a) {
        targetFilePath = path_1.default
            .resolve(module.path, "..", "..", "test-result", "test-result.js");
        (0, src_1.browserifyDeclarative)({
            srcPath: path_1.default.resolve(module.path, "index", "test-code.js"),
            tokensToReplace: {
                MY_MARK_1: "inserted",
            ...
            var fileContent = fs_1.default.readFileSync(targetFilePath).toString();
